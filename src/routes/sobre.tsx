...
const TIMELINE = [
  ...
  { year: "2025", title: "Operação Integrada", text: "Operação Comercial, Growth, Marketing Médico e Tecnologia Avançada passam a operar de forma unificada. Nasce o ecossistema estratégico de soluções do Grupo Dama." },
