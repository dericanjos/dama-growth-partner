  ...
  head: () => ({
    meta: [
      { title: "Grupo DAMA | Solução Completa para Médicos" },
      {
        name: "description",
        content:
          "Operação Comercial Estratégica para Médicos. O Grupo DAMA Health estrutura a frente comercial de consultórios particulares com método, pessoas e tecnologia.",
      },
